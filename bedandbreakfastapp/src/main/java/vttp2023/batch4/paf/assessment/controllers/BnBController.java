...
public class BnBController {
	...
	@ResponseBody
	public ResponseEntity<String> createBooking(@RequestBody Map<String, String> params){
		System.out.println(params);
		Bookings bookings = new Bookings();
		
		bookings.setDuration(Integer.parseInt(params.get("nights")));
		bookings.setEmail(params.get("email"));
