...
public class BookingsRepository {
	...
	public static final String SQL_CREATE_NEW_BOOKING = """
	...
	public void newUser(User user) {
		int rows = template.update(SQL_CREATE_NEW_USER, user.email(), user.name());
	...
	public void newBookings(Bookings bookings) {
		int rows = template.update(SQL_CREATE_NEW_BOOKING, bookings.getBookingId(), bookings.getListingId(), bookings.getDuration(), bookings.getEmail());
		// System.out.println("booking created: " + rows);
	}
}
